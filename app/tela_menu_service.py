...
from . import tela_cadastro_servico
from . import tela_verificar_servico
...
class UserWidget(flet.UserControl):
    ...
    def Create_button(self, text, func, visible_button):
    ...
    def build(self):
        ...
        self._create_service = self.Create_button("Criar serviço", self.func, self._visible_create_service)
        self._edit_service = self.Create_button("Editar servico", self.func2, self._visible_edit_service)
        self._back_ = self.Create_button("Voltar", self.func3, self._visible_back_)
...
async def main(page:flet.page, user):
    ...
    async def _create_servico(e):
        await tela_cadastro_servico.main(page, user)
        
    async def _check_servico(e):
        await tela_verificar_servico.main(page, user)
