...
from . import tela_relatorio_barbeiro
from . import tela_relatorio_receita_mensal
from . import tela_relatorio_despesas
        ...
        return flet.Column(
            ...
            controls=[
                ...
                flet.Column(
                    ...
                    flet.Row(
                        alignment="center",
                        controls=[self._check_barber]),
                    flet.Row(
                        alignment="center",
                        controls=[self._check_month]),
                    flet.Row(
                        alignment="center",
...
async def main(page:flet.page, user):
    ...
    async def _report_barber(e):
        await tela_relatorio_barbeiro.main(page,user)
        # tela_cadastro_servico.main(page, user)
        
    async def _report_month(e):
        await tela_relatorio_receita_mensal.main(page, user)
    
    async def _report_expense(e):
        await tela_relatorio_despesas.main(page, user)
